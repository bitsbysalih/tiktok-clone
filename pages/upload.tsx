      ...
      <div className="w-[60%] bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-between items-center p-14 pt-6">
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          <input
            ...
            className="rouned outline-none text-md border-2 border-gray-200 p-2"
          />
          ...
          <select
            ...
            className="outline-none border-2 border-gray-200 text-md capitalize lg:p-4 p-2 rounded cursour-pointer"
          >
            {topics.map((topic) => (
              <option
